...
**Frontend (Vaska Henrietta / GitHub: ahenus / NEPTUNKÓD: O4YCQE):**
- Angular keretrendszer beállítása
- OpenAPI (Swagger) alapú automatikus API kliens generálás
- UI komponensek elkészítése
- Zoneless architektúra és Signals alapú állapotkezelés
- Kliensoldali Pagination (lapozás) megvalósítása

**Backend & DevOps (Kovács Tamás / GitHub: pomodoro90 / NEPTUNKÓD: NINXQ2):**
- ASP.NET Core API
- MongoDB integráció CORS beállításokkal
- Dockerizáció
...
```
docker run -d -p 27017:27017 --name beadando-mongo mongo:latest
```

**Backend indítása:**
A backend könyvtárból kiadva:
```
dotnet run
```

**Frontend indítása:** 
A frontend könyvtárból kiadva:
```
npm install
ng serve -o
```
